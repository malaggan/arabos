...
void *malloc(size_t req_size)
{
	...
	while ( min != NULL && min->magic == LIBALLOC_MAGIC) /* TODO: the second condition is an ugly hack to an existing bug  */
	{
	    ...
	    if ( min->next != NULL && min->magic == LIBALLOC_MAGIC) /* TODO: the second condition is an ugly hack to an existing bug  */
	    {
